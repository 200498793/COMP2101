...
function displayhelp {
  ...
  echo "  --host          : display the hostname of the system"
  echo "  --domain        : display the domain name of the system"
  echo "  --ipconfig      : display the network configuration of the system"
  echo "If no options are specified, the entire system report will be displayed."
}
